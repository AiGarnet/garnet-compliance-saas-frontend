...
import { CheckCircle, AlertTriangle, Clock, Bot, Upload, FileText, RefreshCw, MessageSquare } from 'lucide-react';
  ...
  if (!questions || questions.length === 0) {
    return (
      <div className="text-center py-12 bg-white rounded-lg border">
        ...
        <p className="text-gray-500">Upload a checklist to extract questions and generate AI answers.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-medium text-gray-900">Questions Overview</h3>
      ...
      <div className="space-y-4">
        {safeMap(questions, (question: ChecklistQuestion) => (
          <div key={question.id} className="bg-white rounded-lg border hover:shadow-md transition-shadow">
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusBadgeColor(question.status)}`}>
              ...
              {question.requiresDocument && (
                <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h5 className="text-sm font-medium text-yellow-900 mb-1">Supporting Document Required</h5>
                      {question.documentDescription && (
                        <p className="text-sm text-yellow-800 mb-3">{question.documentDescription}</p>
                      )}
                      <div className="flex items-center space-x-3">
                        ...
                        {selectedFiles[question.id] && (
                          <div className="flex items-center space-x-2">
                            <span className="text-sm text-yellow-700">{selectedFiles[question.id].name}</span>
                            <button
